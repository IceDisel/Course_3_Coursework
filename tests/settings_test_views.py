...
TEST_DATA_2 = [
    {'id': 441945886, 'state': 'EXECUTED', 'date': '26.08.2019',
    ...
    {'id': 142264268, 'state': 'EXECUTED', 'date': '04.04.2019',
     ...
     'description': 'Перевод со счета на счет', 'from': 'Счет **8542', 'to': 'Счет **4188'},
    {'id': 939719570, 'state': 'EXECUTED', 'date': '30.06.2018',
     'operationAmount': {'amount': '9824.07', 'currency': {'name': 'USD', 'code': 'USD'}},
     'description': 'Перевод организации', 'from': 'Счет **6952', 'to': 'Счет **6702'},
